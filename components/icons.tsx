...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m8.118 0a5.971 5.971 0 0 0 .941 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9.75c0 1.242.988 2.25 2.25 2.25h13.5A2.25 2.25 0 0 0 21 9.75Z" />
  </svg>
);

export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.355a7.5 7.5 0 0 1-3 0m3-12.168v2.168c2.456.566 4.5 2.8 4.5 5.482 0 3.037-2.463 5.5-5.5 5.5S6.5 15.037 6.5 12c0-2.682 2.044-4.916 4.5-5.482V6.332m11.25.002.001-.002zM12 2.25a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75Zm0 0h.001M12 18a.75.75 0 0 0 .75.75h.001a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75h-.002a.75.75 0 0 0-.75.75v1.5Zm-6.036-5.245a.75.75 0 0 0-.75-.75H3a.75.75 0 0 0-.75.75v.002c0 .414.336.75.75.75h2.286a.75.75 0 0 0 .75-.75v-.002Zm14.272 0a.75.75 0 0 0-.75-.75h-2.286a.75.75 0 0 0-.75.75v.002c0 .414.336.75.75.75h2.286a.75.75 0 0 0 .75-.75v-.002Z" />
  </svg>
);
